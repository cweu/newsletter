<?php
/**
 * Template for displaying a newsletter article
 *
 * @package CWA
...
<?php
	...
	$featured_img = pods_image_url( $pods->field( 'featured_img' ), 'thumbnail', 0, true );
...
<div class="body">
	...
	<div class="content artikel">
		...
		<small><?php echo $auteur; ?>, <?php echo date( 'd-m-Y', strtotime( $datum ) ); ?> <?php
			if ( '0.00' != $jaargang_nummer && '' != $jaargang_nummer ) {
				echo ', ISSUE NR. ' . $jaargang_nummer;
			}
		?></small>
		<p class="intro"> <!-- TEXT -->
			<?php echo $intro; ?>
