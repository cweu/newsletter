...
function cwa_newsletter_scripts() {
	...
	if ( is_home() || is_category() || is_post_type_archive( 'newsletter_article' ) || is_post_type_archive( 'newsletter' ) || is_singular( 'newsletter' ) ) {
		// Register Superclamp.
...
require get_template_directory() . '/inc/category-index.php';
